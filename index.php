...
if($is_server_request_post){
    ...
    ");
        ...
        $max_not_top_decks_i = $now_deck_cards_num - 1;
    ...
    ");
        ...
        if($now_deck_cards_num >= 1){
            $draw_card_i = mt_rand(0, $max_not_top_decks_i);
    ...
    ");
        ...
        $now_deck_cards_num = $now_deck_cards_num - 1;
    }
    elseif($_POST["dice"]){
...
<body>
	...
	<p>次元デッキ残り枚数 : <spam class="now_deck_cards_num"><?php h($now_deck_cards_num) ?></spam></p>
	<div class="card_text">
		<?php if($now_deck_cards_num <= 0) : ?>
